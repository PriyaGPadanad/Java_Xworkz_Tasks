...
public class CountryRunner {
    public static void main(String[] args) {
        ...
        countryList.stream().filter((e) -> e.toLowerCase().endsWith("a")).forEach(c -> System.out.println("Country Name :" +c));
        ...
        System.out.println("---------------------------------------------------------");
        System.out.println("6.Sort all countries by ascending");
        ...
        Collection<String> list = countryList.stream()
                .filter(e -> e.toLowerCase().contains("o"))
        ...
        countryList.stream().filter((e) -> e.toLowerCase()
                        .chars()
                        .anyMatch(value -> e.toLowerCase().indexOf(value) != e.toLowerCase().lastIndexOf(value)))
